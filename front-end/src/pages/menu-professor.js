...
class MenuProfessor extends React.Component{
            ...
            success: function(data) {
                $.each(data, function(index, element) {   
                    $.each(element, function(i, e){
                        ...
                        $('#todas-materias').append($('<div class="col"><div id='+e.id+' class="card"><img src="https://64.media.tumblr.com/8b69b19c86e321c791340f370165ba15/tumblr_nvge9wpGCU1u66uqto1_1280.jpg" class="card-img-top" alt="..."><div class="card-body"><h5 class="card-title">'+e.materia+'</h5></div><div class="card-footer"><a>Agendar</a></div></div></div>'));
                ...
                $.each(data, function(index, element) {   
                    $.each(element, function(ind, e){
                        if(!e.isprofessor){
                            console.log(i)
                            console.log(e)
                            $('#todos-alunos').append($('<div class="col"><div id='+e.id+' class="card"><img src="https://64.media.tumblr.com/8b69b19c86e321c791340f370165ba15/tumblr_nvge9wpGCU1u66uqto1_1280.jpg" class="card-img-top" alt="..."><div class="card-body"><h5 class="card-title">'+e.nome+'</h5></div><div class="card-footer">Agendar</div></div></div>'));
                            // Exibe os três primeiros profs em Menu -> Início
                            if(i < 3){
                                $('#tres-primeiros-alunos').append($('<div class="col"><div id='+e.id+' class="card"><img src="https://64.media.tumblr.com/8b69b19c86e321c791340f370165ba15/tumblr_nvge9wpGCU1u66uqto1_1280.jpg" class="card-img-top" alt="..."><div class="card-body"><h5 class="card-title">'+e.nome+'</h5></div><div class="card-footer">Agendar</div></div></div>'));
               ...
               <Tab.Container id="left-tabs-example" defaultActiveKey="tab-inicio">
                <div className="border-end border-dark text-white bg-primario"  id="sidebar-wrapper">
                    ...
                    <Nav className="list-group list-group-flush " role="tablist" >
                        ...
                        <Nav.Item className="list-group-item list-group-item-action p-3 text-white bg-primario" id="botao-tab-alunos" >
                            <Nav.Link className="btn btn-light btn-block w-100 botao-nav"  eventKey="tab-alunos">Alunos</Nav.Link>
                        </Nav.Item>
                    ...
                    <Tab.Content className="tab-content" id="nav-tabContent">
                        ...
                        <Tab.Pane className="m-left-5 container-fluid" eventKey="tab-inicio">
                            <div className="row w-100">
                                <div className="col-8">
                                    ...
                                    <h2 className="mt-4 text-gray">Alunos</h2>
                                    <div className="row">
                                        <div id="tres-primeiros-alunos" className="row row-cols-1 row-cols-md-3 g-4">
                        ...
                        <Tab.Pane className="m-left-5 container-fluid" eventKey="tab-alunos">
                            <div className="row w-75">
                                <h3 className="text-gray">Seus alunos</h3>
                                <div className="row">
                                    <div id="todos-alunos" className="row row-cols-1 row-cols-md-3 g-4">
